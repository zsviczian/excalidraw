...
describe("AnimationController", () => {
  ...
  afterEach(() => {
    ...
    vi.useRealTimers();
    vi.restoreAllMocks(); // zsviczian -- restore window schedulers used by cross-document tests
  });
  ...
  // zsviczian -- protect popout animations from an occluded main-window frame queue
  ...
  // zsviczian -- ensure popout timers are created and released by their owning window
