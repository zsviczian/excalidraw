...
import { isTouchInPenMode } from "../obsidianUtils";
...
export class AppPan {
  ...
  start = (event: React.PointerEvent<HTMLElement> | MouseEvent): boolean => {
    ...
    if (
      !(
        ...
        (((event.button === POINTER_BUTTON.WHEEL ||
          ...
          isTouchInPenMode(app.state, event)) && //zsviczian
    ...
    }, app.ownerWindow); // zsviczian -- pan on the mounted editor's frame scheduler
