...
class App extends React.Component<AppProps, AppState> {
  ...
  private addEventListeners() {
    ...
    this.onRemoveEventListenersEmitter.once(
      ...
      addEventListener(this.ownerWindow, "focus", () => this.triggerRender(true), {
        passive: true,
      }), //zsviczian
      addEventListener(
        this.ownerDocument,
  ...
  private renderInteractiveSceneCallback = ({
    ...
    if (!this.ownerDocument.querySelector(".excalidraw")) {
      return;
  ...
  private async insertClipboardContent(
    ...
    if (!isPlainPaste && isMaybeMermaidDefinition(data.text)) {
      //const api = await import("@excalidraw/mermaid-to-excalidraw"); //zsviczian
  ...
  addElementsFromPasteOrLibrary = (opts: {
    ...
    if (true) {
      //zsviczian - isSafari
      Fonts.loadElementsFonts(duplicatedElements, this.ownerDocument).then((fontFaces) => {
        this.fonts.onLoaded(fontFaces);
      });
    }
  ...
  startLineEditor = (
    ...
    this.setState({ selectedElementIds: { [el.id]: true } }, () => {
      ...
      const linearElementEditor = new LinearElementEditor(
        el as NonDeleted<ExcalidrawLinearElement>, //zsviczian
        this.scene.getNonDeletedElementsMap(),
      );
      this.setState({
        selectedLinearElement: {
  ...
  public updateScene = withBatchedUpdates(
    <K extends keyof AppState>(sceneData: {
      ...
      forceFlushSync?: boolean; //zsviczian
    }) => {
  ...
  private handleCanvasDoubleClick = (
    ...
    if (
      ...
      this.setActiveTool({ type: "eraser" }, { toggle: true }); //zsviczian
      return;
    } // zsviczian - end
  ...
  public insertNewElements = (elements: readonly ExcalidrawElement[], idx?: number) => {
    ...
    for (const chunk of chunkedElements) {
      ...
      const insertionIndex = frameId
        ...
        : null;
      this.scene.insertElementsAtIndex(chunk, idx ?? insertionIndex);
    }
  };

  public insertNewElement = (element: ExcalidrawElement, idx?: number) => {
    //zsviczian added idx for highligher pens
  ...
  private onPointerMoveFromPointerDownHandler(
    ...
    return withBatchedUpdatesThrottled((event: PointerEvent) => {
      //To avoid pointerMove canceling the selection of locked elements on mobile //zsviczian
      if (
  ...
  private handleCanvasContextMenu = (
    ...
    if (this.pan.consumesContextMenuEvent() && !isMiroKeyboardShortcut) { //zsviczian
      return;
    }
    if (this.state.disableContextMenu && !isMiroKeyboardShortcut) { //zsviczian
      return;
    }
